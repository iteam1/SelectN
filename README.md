...
Using AI and NLP techniques to automatically select N representative code samples from large corpora to aid ANTLR grammar development and other document analysis tasks.

## Overview

SelectN is a modular and extensible Python project that helps you select the most representative and diverse samples from large collections of documents. While initially focused on aiding ANTLR grammar development by selecting representative code samples, the architecture is designed to support various document types including:

- Code files (multiple languages)
- ANTLR grammar files
- Configuration files
- Log files
- Structured natural language documents (future)
