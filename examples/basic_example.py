...
# Add the project to the Python path if not installed
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from src.selectn.documents.document import DocumentCollection
from src.selectn.core.feature_extraction import TfidfFeatureExtractor
from src.selectn.core.sampler import HybridSampler
